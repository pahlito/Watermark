...
class CardGameTest : StageTest<Any>() {
    ...
    fun imageNotExistTest5(): CheckResult {
        ...
        position = checkOutput(
            outputString,
            0,
            "The file test${File.separator}notexist.png doesn't exist.".lowercase()
        )
        if (position == -1) return CheckResult(
            false,
            "Incorrect output, when a non existing filename was input."
        )
    ...
    fun imageColorCompLess3Test5(): CheckResult {
        ...
        try {
            ...
            if (!inputFile.exists()) {
                return CheckResult(
                    false,
                    "An input test image file doesn't exist. Try reloading the project."
                )
            }
            ...
            position = checkOutput(
                outputString,
                0,
                "The number of image color components isn't 3.".lowercase()
            )
            if (position == -1) return CheckResult(
                false,
    ...
    fun watermarkNotExistTest5(): CheckResult {
        ...
        try {
            ...
            position =
                checkOutput(outputString, 0, "Input the watermark image filename:".lowercase())
            if (position == -1) return CheckResult(
                false,
    ...
    fun watermarkColorCompLess3Test5(): CheckResult {
        ...
        try {
            ...
            position = checkOutput(
                outputString,
                0,
                "The number of watermark color components isn't 3.".lowercase()
            )
            if (position == -1) return CheckResult(
                false,
    ...
    fun wideWatermarkTest5(): CheckResult {
        ...
        try {
            ...
            position =
                checkOutput(outputString, 0, "The watermark's dimensions are larger.".lowercase())
            if (position == -1) return CheckResult(
                false,
        ...
        for (posMethodInput in posMethodInputs) {
            ...
            try {
                ...
                position = checkOutput(
                    outputString,
                    0,
                    "Do you want to set a transparency color?".lowercase()
                )
                if (position == -1) return CheckResult(
                    false,
                ...
                return CheckResult(
                    false,
                    "An exception was thrown, when trying to open an image file."
                )
            }
            ...
            position = checkOutput(
                outputString,
                0,
                "Input a transparency color ([Red] [Green] [Blue]):".lowercase()
            )
            if (position == -1) return CheckResult(
                false,
            ...
            position =
                checkOutput(
                    outputString,
                    0,
                    "Input the watermark transparency percentage (Integer 0-100):".lowercase()
                )
            if (position == -1) return CheckResult(
                false,
            ...
            position = checkOutput(
                outputString,
                0,
                "Choose the position method (single, grid):".lowercase()
            )
            if (position == -1) return CheckResult(
                false,
            ...
            position =
                checkOutput(outputString, 0, "The position method input is invalid.".lowercase())
            if (position == -1) return CheckResult(
                false,
    ...
    fun invalidPositionTest5(): CheckResult {
        ...
        for (posInput in posInputs) {
            ...
            position = checkOutput(
                outputString,
                0,
                "Input the watermark position ([x 0-300] [y 0-600]):".lowercase()
            )
            if (position == -1) return CheckResult(
                false,
                "Incorrect output, after wrong input position method."
    ...
    fun outOfRangeTest5(): CheckResult {
        ...
        for (posInput in posInputs) {
            ...
            outputString = main.execute(posInput).trim().lowercase()
            position =
                checkOutput(outputString, 0, "The position input is out of range.".lowercase())
            if (position == -1) return CheckResult(
                false,
    ...
    fun gridPositionUsingTransparencyTest5(): CheckResult {
        try {
            ...
            return CheckResult(
                false,
                "An exception was thrown, when trying to delete a previous created output file."
            )
        }
        ...
        try {
            ...
            outputString = main.execute("test${File.separator}logorgb.png").trim().lowercase()
            position =
                checkOutput(outputString, 0, "Do you want to set a transparency color?".lowercase())
            if (position == -1) return CheckResult(
                false,
                "Incorrect output, after a watermark filename was input."
            )
        ...
        position =
            checkOutput(outputString, 0, "Choose the position method (single, grid):".lowercase())
        if (position == -1) return CheckResult(
            false,
            "Incorrect output, when the transparency percentage was input."
        )
        ...
        position = checkOutput(
            outputString,
            0,
            "Input the output image filename (jpg or png extension):".lowercase()
        )
        if (position == -1) return CheckResult(
            false,
        ...
        position = checkOutput(
            outputString,
            0,
            "The watermarked image test${File.separator}out1.png has been created.".lowercase()
        )
        if (position == -1) return CheckResult(
            false,
        ...
        if (!checkIfCorrectOutputFileTransparencyColorGridS5(
                15,
                50000,
                "test${File.separator}image5.png",
                "test${File.separator}logorgb.png",
                "test${File.separator}out1.png",
                Color(0, 0, 0)
            )
        )
            return CheckResult(
    ...
    fun gridPositionAlphaChannelTest5(): CheckResult {
        ...
        try {
            ...
            position = checkOutput(
                outputString,
                0,
                "Do you want to use the watermark's Alpha channel?".lowercase()
            )
            if (position == -1) return CheckResult(
                false,
                "Incorrect output, after a watermark filename was input."
        ...
        position = checkOutput(
            outputString,
            0,
            "The watermarked image test${File.separator}out2.png has been created.".lowercase()
        )
        if (position == -1) return CheckResult(
            false,
            "Incorrect output, when the output filename was input."
        ...
        if (!checkIfCorrectOutputFileAlphaChannelGridS5(
                25,
                50000,
                "test${File.separator}image5.png",
                "test${File.separator}logorgba.png",
                "test${File.separator}out2.png"
            )
        )
            return CheckResult(
                false,
    ...
    fun singlePositionUsingTransparencyTest5(): CheckResult {
        ...
        position = checkOutput(
            outputString,
            0,
            "The watermarked image test${File.separator}out3.png has been created.".lowercase()
        )
        if (position == -1) return CheckResult(
            false,
            "Incorrect output, when the output filename was input."
        ...
        if (!checkIfCorrectOutputFileTransparencyColorSingleS5(
                35,
                50000,
                "test${File.separator}image5.png",
                "test${File.separator}logorgb.png",
                "test${File.separator}out3.png",
                Color(0, 0, 0),
                200,
                200
            )
    ...
    fun singlePositionAlphaChannelTest5(): CheckResult {
        ...
        position = checkOutput(
            outputString,
            0,
            "The watermarked image test${File.separator}out4.png has been created.".lowercase()
        )
        if (position == -1) return CheckResult(
            false,
            "Incorrect output, when the output filename was input."
        ...
        if (!checkIfCorrectOutputFileAlphaChannelSingleS5(
                50,
                50000,
                "test${File.separator}image5.png",
                "test${File.separator}logorgba.png",
                "test${File.separator}out4.png",
                300,
                400
            )
        )
...
fun checkIfCorrectOutputFileAlphaChannelSingleS5(
    per: Int, err: Long, imageStr: String, watStr: String,
    outStr: String, posX: Int, posY: Int
): Boolean {
    ...
    for (y in 0 until image.height) {
        for (x in 0 until image.width) {
            val color =
                if (x in posX until (posX + wat.width) && y in posY until (posY + wat.height))
...
fun checkIfCorrectOutputFileTransparencyColorSingleS5(
    per: Int, err: Long, imageStr: String, watStr: String,
    outStr: String, trColor: Color, posX: Int, posY: Int
): Boolean {
    val imageFile = File(imageStr)
    val image = ImageIO.read(imageFile)
    val watermarkFile = File(watStr)
...
fun checkIfCorrectOutputFileAlphaChannelGridS5(
    per: Int, err: Long,
    imageStr: String, watStr: String, outStr: String
): Boolean {
    val imageFile = File(imageStr)
    val image = ImageIO.read(imageFile)
    val watermarkFile = File(watStr)
...
fun checkIfCorrectOutputFileTransparencyColorGridS5(
    per: Int, err: Long,
    imageStr: String, watStr: String, outStr: String, trColor: Color
): Boolean {
    val imageFile = File(imageStr)
    val image = ImageIO.read(imageFile)
    val watermarkFile = File(watStr)
